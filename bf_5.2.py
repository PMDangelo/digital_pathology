...
subprocess.call([sys.executable, '-m','pip','install','stardist','imagecodecs','csbdeep'])
check_call(['apt-get', 'install', '-y', 'openslide-tools'], stdout=open(os.devnull,'wb'), stderr=STDOUT)
subprocess.call([sys.executable, '-m','pip','install','openslide-python'])
